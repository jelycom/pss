	...
	a.jgrid.extend({
		searchGrid:function(c){
			...
			return this.each(function(){
				function d(b){
					...
					r&&(a.jgrid.viewModal("#"+a.jgrid.jqID(u.themodal),{gbox:"#gbox_"+a.jgrid.jqID(n),jqm:c.jqModal,modal:c.modal,overlay:c.overlay,toTop:c.toTop}),a(e).triggerHandler("jqGridFilterAfterShow",[b]),a.isFunction(c.afterShowSearch)&&c.afterShowSearch.call(e,b))
				}
				var e=this;
				if(e.grid){
					var n="fbox_"+e.p.id,
					...
					if(void 0!==a("#"+a.jgrid.jqID(u.themodal))[0])		d(a("#fbox_"+a.jgrid.jqID(+e.p.id)));
						...
						var p=a.extend([],e.p.colModel),
							w="<a href='javascript:void(0)' id='"+n+"_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>"+c.Find+"</a>",
							b="<a href='javascript:void(0)' id='"+n+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+c.Reset+"</a>",
							s="",
							h="",
							j,
							i=!1,
						...
						c.columns.length?p=c.columns:a.each(p,function(a,b){
							...
							if(!i){
								...
								if(b.searchoptions&&b.searchoptions.searchhidden===true&&c||c&&!d){
									i=true;
									j=b.index||b.name;q=a
								}
							}
						});
						if(!t&&j||!1===c.multipleSearch){
							var y="eq";
							0<=q&&p[q].searchoptions&&p[q].searchoptions.sopt?y=p[q].searchoptions.sopt[0]:c.sopt&&c.sopt.length&&(y=c.sopt[0]);
							t={groupOp:"AND",rules:[{field:j,op:y,data:""}]}
						}
						i=!1;
						c.tmplNames&&c.tmplNames.length&&(i=!0,h=c.tmplLabel,h+="<select class='ui-template'>",h+="<option value='default'>Default</option>",a.each(c.tmplNames,function(a,b){h=h+("<option value='"+a+"'>"+b+"</option>")}),h+="</select>");
						g="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+n+"_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:"+g+"'>"+b+h+"</td><td class='EditButton' "+f+">"+s+w+"</td></tr></tbody></table>";
						n=a.jgrid.jqID(n);
						a("#"+n).jqFilter({
							columns:p,
						...
						a(e).triggerHandler("jqGridFilterInitialize",[a("#"+n)]);
						...
						a("#"+n+"_search").bind("click",function(){
							var b=a("#"+n),d={},h,f=b.jqFilter("filterData"),init=a(e).data("initFilter");
							if(c.errorcheck){
								b[0].hideError();
							...
							if(c.stringResult){
								...
								if(typeof h==="string"){
									d[c.sFilter]=h;
									a.each([c.sField,c.sValue,c.sOper],function(){d[this]=""})
								}
							...
							e.p.search=true;
							if (init)	d.filters='{'+init.substring(1,init.length-1)+',"groups":['+d.filters+']}';
						...
						a("#"+n+"_reset").bind("click",function(){
							var b={},d=a("#"+n),f=a(e).data("initFilter");
							e.p.search=false;
							...
							if (f)	a(e).setGridParam({postData:{'filters':f}}).trigger("reloadGrid",[{page:1}]);
							else	a(e).trigger("reloadGrid",[{page:1}]);
							return false
						});
						d(a("#"+n));
		...
		return this.each(function(){
					...
					if(c.length){
						...
						a.each(b.p.colModel,function(){
							if(this.name===d&&this.editoptions&&a.isFunction(this.editoptions.custom_value)){
								try{
									if(k[d]=this.editoptions.custom_value.call(b,a("#"+a.jgrid.jqID(d),i),"get"),void 0===k[d])		throw"e1";
								}catch(c){
			...
			function n(d,e,h,k){
					...
					if("cb"!==f&&"subgrid"!==f&&!0===this.editable&&"rn"!==f){
						if(!1===v)		i="";
							...
							try{
								...
								i=this.edittype&&"textarea"==this.edittype?a("td:eq("+o+")",e.rows[v]).text():a("td:eq("+o+")",e.rows[v]).html()
							}
							if(!i||"&nbsp;"==i||"&#160;"==i||1==i.length&&160==i.charCodeAt(0))		i=""
						}
						var r=a.extend({},this.editoptions||{},{id:f,name:f}),
							t=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),
							u=parseInt(t.rowpos,10)||j+1,y=parseInt(2*(parseInt(t.colpos,10)||1),10);
						...
						t.rowabove&&(r=a("<tr><td class='contentinfo' colspan='"+2*k+"'>"+t.rowcontent+"</td></tr>"),a(h).append(r),r[0].rp=u);
				...
				if(0<j&&(o=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*k-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+e.p.id+"_id' value='"+d+"'/></td></tr>"),o[0].rp=j+999,a(h).append(o),c[b.p.id].checkOnSubmit||c[b.p.id].checkOnUpdate))	c[b.p.id]._savedData[e.p.id+"_id"]=d;
				return n
			}
			function r(d,e,h){
				var f,k=0,g,m,j,q,l;
				...
				if("_empty"==d)
					a(o).each(function(){
						...
						if((m=a("#"+a.jgrid.jqID(f),"#"+h))&&m.length&&null!==m[0])
							if(q="",j.defaultValue?(q=a.isFunction(j.defaultValue)?j.defaultValue.call(b):j.defaultValue,"checkbox"==m[0].type?(l=q.toLowerCase(),0>l.search(/(false|0|no|off|undefined)/i)&&""!==l?(m[0].checked=!0,m[0].defaultChecked=!0,m[0].value=q):(m[0].checked=!1,m[0].defaultChecked=!1)):m.val(q)):"checkbox"==m[0].type?(m[0].checked=!1,m[0].defaultChecked=!1,q=a(m).attr("offval")):m[0].type&&"select"==m[0].type.substr(0,6)?m[0].selectedIndex=0:m.val(q),!0===c[b.p.id].checkOnSubmit||c[b.p.id].checkOnUpdate)
								c[b.p.id]._savedData[f]=q
					}),
					a("#id_g","#"+h).val(d);
				else{
					...
					n&&(a('td[role="gridcell"]',n).each(function(m){
														...
														if("cb"!==f&&"subgrid"!==f&&"rn"!==f&&!0===o[m].editable){
															...
															if(!0===c[b.p.id].checkOnSubmit||c[b.p.id].checkOnUpdate)
																c[b.p.id]._savedData[f]=g;
															f=a.jgrid.jqID(f);
															switch(o[m].edittype){
																case "password":
																case "text":
																...
																case "select":
																	var j=g.split(","),
																		j=a.map(j,function(b){return a.trim(b)});
...
"prop":"attr"]("checked",!0),a("#"+f,"#"+h)[b.p.useProp?"prop":"attr"]("defaultChecked",!0)):(a("#"+f,"#"+h)[b.p.useProp?"prop":"attr"]("checked",!1),a("#"+f,"#"+h)[b.p.useProp?"prop":"attr"]("defaultChecked",!1)));
																...
																case "custom":
																	try{
																		if(o[m].editoptions&&a.isFunction(o[m].editoptions.custom_value))
																			o[m].editoptions.custom_value.call(b,a("#"+f,"#"+h),"set",g);
																		else throw"e1";
																	}catch(q){
...
a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,q.message,jQuery.jgrid.edit.bClose)
			...
			function t(){
				var e,
					f=[!0,"",""],
					m={},
					g=b.p.prmNames,j,o,l,n,v,
					p=a(b).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+h),z]);
					p&&"object"===typeof p&&(k=p);
					a.isFunction(c[b.p.id].beforeCheckValues)&&(p=c[b.p.id].beforeCheckValues.call(b,k,a("#"+h),"_empty"==k[b.p.id+"_id"]?g.addoper:g.editoper))&&"object"===typeof p&&(k=p);
					for(l in k)
						if(k.hasOwnProperty(l)&&(f=a.jgrid.checkValues.call(b,k[l],l,b),!1===f[0]))
							break;
					u();
...
k,a("#"+h))));
					if(f[0]&&!c[b.p.id].processing){
						c[b.p.id].processing=!0;a("#sData",i+"_2").addClass("ui-state-active");
						o=g.oper;
						j=g.id;
						...
						if(!0===b.p.treeGrid)
							for(v in k[o]==g.addoper&&(n=a(b).jqGrid("getGridParam","selrow"),k["adjacency"==b.p.treeGridModel?b.p.treeReader.parent_id_field:"parent_id"]=n),b.p.treeReader)
								b.p.treeReader.hasOwnProperty(v)&&(m=b.p.treeReader[v],k.hasOwnProperty(m)&&!(k[o]==g.addoper&&"parent_id_field"===v)&&delete k[m]);
							...
							v=a.extend({url:c[b.p.id].url?c[b.p.id].url:a(b).jqGrid("getGridParam","editurl"),type:c[b.p.id].mtype,data:a.isFunction(c[b.p.id].serializeEditData)?c[b.p.id].serializeEditData.call(b,k):k,complete:function(m,l){
																																																									...
																																																									if(l!="success"){
																																																										...
																																																										f[1]=a.isFunction(c[b.p.id].errorTextFormat)?c[b.p.id].errorTextFormat.call(b,m):l+" Status: '"+m.statusText+"'. Error code: "+m.status
																																																									}else{
																																																									...
																																																									if(f[0]===false){
																																																										...
																																																										a.each(b.p.colModel,function(){
																																																											if(B[this.name]&&this.formatter&&this.formatter=="select")
																																																												try{
																																																													delete B[this.name]
																																																												}catch(a){}
																																																										});
																																																										k=a.extend(k,B);
																																																										b.p.autoencode&&a.each(k,function(b,d){
																																																															...
																																																															if(k[o]==g.addoper){
																																																																...
																																																																if(c[b.p.id].closeAfterAdd){
																																																																	...
																																																																	else if(b.p.treeGrid===true)
																																																																		a(b).jqGrid("addChildNode",f[2],n,k);
																																																																	else{
																																																																		a(b).jqGrid("addRowData",f[2],k,d.addedrow);
																																																																		a(b).jqGrid("setSelection",f[2])}a.jgrid.hideModal("#"+a.jgrid.jqID(q.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:d.jqModal,onClose:c[b.p.id].onClose})
																																																																}else if(c[b.p.id].clearAfterAdd){
																																																																	c[b.p.id].reloadAfterSubmit?a(b).trigger("reloadGrid"):b.p.treeGrid===true?a(b).jqGrid("addChildNode",f[2],n,k):a(b).jqGrid("addRowData",f[2],k,d.addedrow);
																																																																	r("_empty",b,h)
																																																																}else 
																																																																	c[b.p.id].reloadAfterSubmit?a(b).trigger("reloadGrid"):b.p.treeGrid===true?a(b).jqGrid("addChildNode",f[2],n,k):a(b).jqGrid("addRowData",f[2],k,d.addedrow)
																																																															}else{
																																																																if(c[b.p.id].reloadAfterSubmit){
																																																																	...
																																																																	b.p.treeGrid===true?a(b).jqGrid("setTreeRow",k[j],k):a(b).jqGrid("setRowData",k[j],k);
							...
							a.jgrid.ajaxOptions,
							c[b.p.id].ajaxEditOptions);
							!v.url&&!c[b.p.id].useDataProxy&&(a.isFunction(b.p.dataProxy)?c[b.p.id].useDataProxy=!0:(f[0]=!1,f[1]+=" "+a.jgrid.errors.nourl));
							f[0]&&(c[b.p.id].useDataProxy?(m=b.p.dataProxy.call(b,v,"set_"+b.p.id),
															"undefined"==typeof m&&(m=[!0,""]),
															!1===m[0]?(f[0]=!1,f[1]=m[1]||"Error deleting the selected row!"):(v.data.oper==g.addoper&&c[b.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(q.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:d.jqModal,onClose:c[b.p.id].onClose}),
																																v.data.oper==g.editoper&&c[b.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(q.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:d.jqModal,onClose:c[b.p.id].onClose})
																															)
															):a.ajax(v))
					}
			...
			function g(){
				var d=!0;
				a("#FormError",i).hide();
				if(c[b.p.id].checkOnUpdate&&(k={},B={},e(),F=a.extend({},k,B),M=l(F,c[b.p.id]._savedData)))
					a("#"+h).data("disabled",!0),
			...
			function f(){
				if("_empty"!==o&&"undefined"!==typeof b.p.savedRow&&0<b.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))
					for(var d=0;d<b.p.savedRow.length;d++)
						if(b.p.savedRow[d].id==o){
			...
			if(b.grid&&o){
				var s=b.p.id,
					...
					y=a.isFunction(c[b.p.id].beforeShowForm)?c[b.p.id].beforeShowForm:!1,
					A=a.isFunction(c[b.p.id].afterShowForm)?c[b.p.id].afterShowForm:!1,
					x=a.isFunction(c[b.p.id].beforeInitData)?c[b.p.id].beforeInitData:!1,
					m=a.isFunction(c[b.p.id].onInitializeForm)?c[b.p.id].onInitializeForm:!1,
					v=!0,
					E=1,
					H=0,
					k,B,F,M,z,
				...
				if(void 0!==a("#"+a.jgrid.jqID(q.themodal))[0]){
					...
					c[b.p.id].bottominfo?(a(".bottominfo",i+"_2").html(c[b.p.id].bottominfo),a(".binfo",i+"_2").show()):a(".binfo",i+"_2").hide();
					r(o,b,h);
					...
					var G=isNaN(d.dataheight)?d.dataheight:d.dataheight+"px",
						G=a("<form name='FormPost' id='"+h+"' class='FormGrid' onSubmit='return false;' style='width:100%;overflow:auto;position:relative;height:"+G+";'></form>").data("disabled",!1),
						C=a("<table id='"+j+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
						v=a(b).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+h),z]);
					"undefined"==typeof v&&(v=!0);
					v&&x&&(v=x.call(b,a("#"+h)));
					if(!1===v)	return;
					f();
					a(b.p.colModel).each(function(){
						...
						E=Math.max(E,a?a.colpos||0:0);H=Math.max(H,a?a.rowpos||0:0)});
						a(G).append(C);
						...
						x[0].rp=0;
						a(C).append(x);
						var v=(x="rtl"==b.p.direction?!0:!1)?"nData":"pData",
							D=x?"pData":"nData";
						n(o,b,C,E);
						var v="<a href='javascript:void(0)' id='"+v+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
							...
							j="<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"+j+"_2'><tbody><tr><td colspan='2'>" +
								"<hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+
								(x?D+v:v+D)+"</td><td class='EditButton'>"+J+K+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+
								c[b.p.id].bottominfo+"</td></tr>"),
							j=j+"</tbody></table>";
							if(0<H){
								var L=[];
								a.each(a(C)[0].rows,function(a,b){L[a]=b});
								L.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});
								a.each(L,function(b,d){a("tbody",C).append(d)})
							}
							d.gbox="#gbox_"+a.jgrid.jqID(s);
							var N=!1;
							!0===d.closeOnEscape&&(d.closeOnEscape=!1,N=!0);
							j=a("<span></span>").append(G).append(j);
							a.jgrid.createModal(q,j,d,"#gview_"+a.jgrid.jqID(b.p.id),a("#gbox_"+a.jgrid.jqID(b.p.id))[0]);
							x&&(a("#pData, #nData",i+"_2").css("float","right"),a(".EditButton",i+"_2").css("text-align","left"));
							c[b.p.id].topinfo&&a(".tinfo",i).show();c[b.p.id].bottominfo&&a(".binfo",i+"_2").show();
							j=j=null;
							...
							d.checkOnUpdate&&(a("a.ui-jqdialog-titlebar-close span","#"+a.jgrid.jqID(q.themodal)).removeClass("jqmClose"),
							...
							!0===d.saveicon[0]&&a("#sData",i+"_2").addClass("right"==d.saveicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+d.saveicon[2]+"'></span>");
							...
							if(c[b.p.id].checkOnSubmit||c[b.p.id].checkOnUpdate)
								J="<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+d.bYes+"</a>",
								D="<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+d.bNo+"</a>",
								K="<a href='javascript:void(0)' id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+d.bExit+"</a>",
								j=d.zIndex||999,
								j++,
								a("<div class='ui-widget-overlay jqgrid-overlay confirm' style='z-index:"+j+";display:none;'>&#160;"+(a.browser.msie&&6==a.browser.version?'<iframe style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>':"")+
									"</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(j+1)+"'>"+d.saveData+"<br/><br/>"+J+D+K+"</div>").insertAfter("#"+h),
							...
							y&&y.call(b,a("#"+h));
							a("#"+a.jgrid.jqID(q.themodal)).data("onClose",c[b.p.id].onClose);
							a.jgrid.viewModal("#"+a.jgrid.jqID(q.themodal),{gbox:"#gbox_"+a.jgrid.jqID(s),jqm:d.jqModal,overlay:d.overlay,modal:d.modal});
							I||a(".jqmOverlay").click(function(){
								if(!g())	return false;
								a.jgrid.hideModal("#"+a.jgrid.jqID(q.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:d.jqModal,onClose:c[b.p.id].onClose});
								return false
							...
							a("#cData",i+"_2").click(function(){if(!g())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(q.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:d.jqModal,onClose:c[b.p.id].onClose});return false});a("#nData",i+"_2").click(function(){if(!g())return false;
...
viewGridRow:function(o,d){
	...
	return this.each(function(){
		function e(){
			(!0===c[l.p.id].closeOnEscape||!0===c[l.p.id].navkeys[0])&&setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(s.modalhead)).focus()},0)
		}
		function n(b,c,e,f){for(var g,h,j,i=0,o,q,l=[],n=!1,p="<td class='CaptionTD form-view-label ui-widget-content' width='"+
...
typeof d.label?c.p.colNames[b]:d.label)+"</b>");a("td:eq("+(p-1)+")",j[0]).append("<span>"+o+"</span>").attr("id","v_"+g);x&&a("td:eq("+(p-1)+") span",j[0]).css({"text-align":"right",width:y+"px"});l[i]=b;i++}});0<i&&(b=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+b+"'/></td></tr>"),b[0].rp=i+99,a(e).append(b));return l}
		function r(b,c){var d,e,f=0,g,h;if(h=a(c).jqGrid("getInd",b,!0))a("td",h).each(function(b){d=c.p.colModel[b].name;e=c.p.colModel[b].editrules&&!0===c.p.colModel[b].editrules.edithidden?!1:!0===c.p.colModel[b].hidden?!0:!1;"cb"!==d&&("subgrid"!==d&&"rn"!==d)&&(g=d==c.p.ExpandColumn&&!0===c.p.treeGrid?a(this).text():a(this).html(),a.extend({},c.p.colModel[b].editoptions||{}),d=a.jgrid.jqID("v_"+d),a("#"+d+" span","#"+p).html(g),e&&a("#"+d,"#"+p).parents("tr:first").hide(),f++)}),0<f&&a("#id_g","#"+p).val(b)}
		function u(b,c){0===b?a("#pData","#"+p+"_2").addClass("ui-state-disabled"):a("#pData","#"+p+"_2").removeClass("ui-state-disabled");b==c?a("#nData","#"+p+"_2").addClass("ui-state-disabled"):a("#nData","#"+p+"_2").removeClass("ui-state-disabled")}
		function t(){var b=a(l).jqGrid("getDataIDs"),c=a("#id_g","#"+p).val();return[a.inArray(c,b),b]}
		var l=this;
		if(l.grid&&o){
			var g=l.p.id,f="ViewGrid_"+a.jgrid.jqID(g),p="ViewTbl_"+a.jgrid.jqID(g),
				w="ViewGrid_"+g,b="ViewTbl_"+g,
				s={themodal:"viewmod"+g,modalhead:"viewhd"+g,modalcontent:"viewcnt"+g,scrollelm:f},
				h=a.isFunction(c[l.p.id].beforeInitData)?c[l.p.id].beforeInitData:!1,
				j=!0,i=1,q=0;
			if(void 0!==a("#"+a.jgrid.jqID(s.themodal))[0]){
				...
				a("#FormError","#"+p).hide();
				r(o,l);
				a.isFunction(c[l.p.id].beforeShowForm)&&c[l.p.id].beforeShowForm.call(l,a("#"+f));a.jgrid.viewModal("#"+a.jgrid.jqID(s.themodal),{gbox:"#gbox_"+a.jgrid.jqID(g),jqm:d.jqModal,jqM:!1,overlay:d.overlay,modal:d.modal});e()}else{var y=isNaN(d.dataheight)?
...
(function(a){
	a.fn.jqFilter=function(d){
		...
		var o=a.extend(!0,{filter:null,columns:[],onChange:null,afterRedraw:null,checkValues:null,error:!1,errmsg:"",errorcheck:!0,showQuery:!0,sopt:null,
				ops:[{name:"eq",description:"equal",operator:"="},
				  ...
				  numopts:"eq ne lt le gt ge nu nn in ni".split(" "),stropts:"eq ne bw bn ew en cn nc nu nn in ni".split(" "),_gridsopt:[],groupOps:[{op:"AND",text:"AND"},{op:"OR",text:"OR"}],groupButton:!0,ruleButtons:!0,direction:"ltr"},a.jgrid.filter,d||{});
		return this.each(function(){
			if(!this.filter){
				this.p=o;
				...
				if(this.p._gridsopt.length)
					for(d=0;d<this.p._gridsopt.length;d++)
						this.p.ops[d].description=this.p._gridsopt[d];
				this.p.initFilter=a.extend(!0,{},this.p.filter);
				if(n){
					for(d=0;d<n;d++)
						if(f=this.p.columns[d],f.stype?f.inputtype=f.stype:f.inputtype||(f.inputtype="text"),f.sorttype?f.searchtype=f.sorttype:f.searchtype||(f.searchtype="string"),void 0===f.hidden&&(f.hidden=!1),f.label||(f.label=f.name),f.index&&(f.name=f.index),f.hasOwnProperty("searchoptions")||(f.searchoptions={}),!f.hasOwnProperty("searchrules"))
							f.searchrules={};
					...
					var r=function(g,k){
						var b=[!0,""];
						if(k&&a.isFunction(k.searchrules))
							b=k.searchrules(g,k);
					...
					this.createTableForGroup=function(g,k){
						var b=this,c,
							e=a("<table class='group ui-widget ui-widget-content' style='border:0px none;'><tbody></tbody></table>"),
							d="left";
						...
						if(!0===this.p.ruleButtons){
							...
							d.append(i);
							var h="",f;
							for(c=0;c<o.groupOps.length;c++)
								f=g.groupOp===b.p.groupOps[c].op?" selected='selected'":"",h+="<option value='"+b.p.groupOps[c].op+"'"+f+">"+b.p.groupOps[c].text+"</option>";
						...
						h="<span></span>";
						this.p.groupButton&&(h=a("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>"),h.bind("click",function(){if(g.groups===void 0)g.groups=[];g.groups.push({groupOp:o.groupOps[0].op,rules:[],groups:[]});b.reDraw();b.onchange();return false}));
						d.append(h);
						if(!0===this.p.ruleButtons){
							...
							h.bind("click",function(){
								...
								g.rules.push({field:l.name,op:(l.searchoptions.sopt?l.searchoptions.sopt:b.p.sopt?b.p.sopt:l.searchtype==="string"?b.p.stropts:b.p.numopts)[0],data:""});
								b.reDraw();
								return false
							});
							d.append(h)
						}
						null!==k&&(h=a("<input type='button' value='-' title='Delete group' class='delete-group'/>"),d.append(h),h.bind("click",function(){for(c=0;c<k.groups.length;c++)if(k.groups[c]===g){k.groups.splice(c,1);break}b.reDraw();b.onchange();return false}));
						if(void 0!==g.groups)
						...
						if(void 0!==g.rules){
							var m=[];
							$.each(b.p.columns,function(i,n){
								m.push(n.name);
							})
							for(c=0;c<g.rules.length;c++)
								if ($.inArray(g.rules[c].field,m)>=0)
									e.append(this.createTableRowForRule(g.rules[c],g));
						}
						return e
					};
					this.createTableRowForRule=function(g,d){
						...
						n.bind("change",function(){
							...
							if(i){
								...
								for(e=0;e<f.length;e++)
									p=a.inArray(f[e],q),
									-1!==p&&(0===k&&(g.op=b.p.ops[p].name),d+="<option value='"+b.p.ops[p].name+"'>"+b.p.ops[p].description+"</option>",k++);
								...
								a(".input-elm",h).bind("change",function(c){
									...
									setTimeout(function(){
										var d=c.target;
										g.data=d.nodeName.toUpperCase()==="SPAN"&&i.searchoptions&&a.isFunction(i.searchoptions.custom_value)?i.searchoptions.custom_value(a(d).children(".customelement:first"),"get"):d.value;
										b.onchange()
									},d)
								});
								setTimeout(function(){
						...
						for(e=m=0;e<b.p.columns.length;e++){
							...
							if(!0===b.p.columns[e].searchoptions.searchhidden&&l||l&&!r)
								l="",
					...
					1);break}b.reDraw();b.onchange();return false}));return c};
					this.getStringForGroup=function(a){
						var colname=[];
						$.each(this.p.columns,function(i,n){
							colname.push(n.name);
						});
						var d="(",b;
						if(void 0!==a.groups)
						...
						if(void 0!==a.rules)
							try{
								for(b=0;b<a.rules.length;b++)
									if ($.inArray(a.rules[b].field,colname)>=0)	1<d.length&&(d+=" "+a.groupOp+" "),d+=this.getStringForRule(a.rules[b])
							}catch(e){
								alert(e)
							}
						d+=")";
					...
					this.toUserFriendlyString=function(){return this.getStringForGroup(o.filter)};
					...
					this.reDraw();
					if(this.p.showQuery)this.onchange();this.filter=!0
				}
			}})};
