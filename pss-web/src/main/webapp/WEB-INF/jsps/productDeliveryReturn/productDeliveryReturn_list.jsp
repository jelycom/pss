...
<script type="text/javascript">
	$(function() {
		...
		var gridoptions={
			url:'productDeliveryReturn_listjson.action',
			caption:'销售退货管理',
			colNames:['','录单日期','单据编号','客户单位','联系人','经手人', '收货仓库','退款金额','状态'],
			colModel:[
					{name:'id',editable:false,hidden:true,gridview:false}
		...
		var naviPrm={
				...
				del:{url:'productDeliveryReturn_delete.action'}
			};
		...
		$('.definedForm').bind('dialogopen',function(event,ui){
			var $extendbuttons = $("<div class='extend-buttons' style='float:left;'>"+
									"<button onclick='selectBill(\"productDelivery\",true)'>选择销售单</button>"+
									"</div>")
...
<body>
	...
	<div class="definedForm">
		<form id="mainform" action="productDeliveryReturn_save.action" method="POST">
			<div class="add_del">
			...
			<table class="out_table">
				<tr>
	            	...
	            	<td>
	            		<input type="text" id="item" name="item" readonly="readonly" url="productDeliveryReturn_getItem.action" />
	            	</td>
	            </tr>
	            <tr>
	        ...
	        <table class="out_table">
	        	<tr>
	                ...
	                <td><label for="paid">退款金额</label></td>
