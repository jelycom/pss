...
<script type="text/javascript">
	$(function() {
		...
		var gridoptions={
			url:'inventoryLoss_listjson.action',
			caption:'盘亏单管理',
		...
		var naviPrm={
				...
				del:{url:'inventoryLoss_delete.action'}
			};
...
<body>
	...
	<div class="definedForm">
		<form id="mainform" action="inventoryLoss_save.action" method="post">
			<div class="add_del">
			...
			<table class="out_table">
				<tr>
	            	...
	            	<td>
	            		<input type="text" id="item" name="item" readonly="readonly" url="inventoryLoss_getItem.action" />
	            	</td>
	            </tr>
	            <tr>
