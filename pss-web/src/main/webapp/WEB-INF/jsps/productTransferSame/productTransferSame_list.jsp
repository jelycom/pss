...
<script type="text/javascript">
	$(function() {
		...
		var gridoptions={
			url:'productTransferSame_listjson.action',
			caption:'同价调拨单管理',
		...
		var naviPrm={
				...
				del:{url:'productTransferSame_delete.action'}
			};
...
<body>
	...
	<div class="definedForm">
		<form id="mainform" action="productTransferSame_save.action" method="post">
			<div class="add_del">
			...
			<table class="out_table">
				<tr>
	            	...
	            	<td>
	            		<input type="text" id="item" name="item" readonly="readonly" url="productTransferSame_getItem.action" />
	            	</td>
	            </tr>
	            <tr>
